...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2020 a las 07:20:44
...
CREATE TABLE `profesores` (
  ...
  `labor` varchar(15) COLLATE utf8_bin NOT NULL,
  `correo_p` varchar(50) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `cursos`
  ADD CONSTRAINT `cursos_ibfk_1` FOREIGN KEY (`id_profesores`) REFERENCES `profesores` (`id_profesor`),
  ADD CONSTRAINT `cursos_ibfk_2` FOREIGN KEY (`id_alumnos`) REFERENCES `alumnos` (`id_alumno`);
COMMIT;
